              ...
              <div className="sign">
                ...
                <div className="sign-body">
                  <p>
                    ...
                    with individuals. Center for Corporate Information
                    Disclosure. Information of a professional participant in the
                    securities market. Information about persons under whose
                    control or significant influence the Partner Banks are. By
                    leaving an application, you agree to the processing of
                    personal data, obtaining information, obtaining access to a
                    credit history, using an analogue of a handwritten
                    signature, an offer, a policy regarding the processing of
                    personal data, a form of consent to the processing of
                    personal data.
                  </p>
                  ...
                  <div className="sign-footer">
                    <div className="agree_check">
                      <input type="checkbox" onChange={handleChange} data-testid="CHECKBOX_ID"/>
                    </div>
